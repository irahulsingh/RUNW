# RUNW(clone of https://github.com/erikras/react-redux-universal-hot-example)
...
A demonstration of this app can be seen [running on heroku](https://roomster.herokuapp.com).
...
* [Some Basic Conventions](GUIDELINES.md)
